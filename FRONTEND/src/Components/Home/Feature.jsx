...
const Feature = () => {
  const [isHover, setIsHover] = React.useState(false);
    ...
    return (
        <div className='flex flex-col items-center my-0 scroll-mt-0 bg-[#000000]' id='features'>
        <div className="flex items-center gap-2 text-sm text-black  border border-[#A6FF5D] rounded-full px-6 py-1.5 mt-10 bg-[#A6FF5D]">
            <Zap  width={14}/>
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Real-Time Resume Analysis</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Get instant insights into your resume — analyze it against job descriptions and see your ATS score in seconds.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Data Privacy First</h3>
                                <p className="text-sm text-slate-600 max-w-xs">We ensure your resume and job data stay private and protected at every step.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Smart Resume Reports</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Download clear, structured reports to understand and improve your resume score.</p>
                            </div>
                        </div>
                    </div>
                </div>
