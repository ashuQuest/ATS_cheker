import { ArrowBigRight, ArrowLeft, ArrowRightFromLine, ArrowRightIcon, NotepadTextIcon } from 'lucide-react';
            ...
            <header className='bg-black text-white flex flex-col items-center bg-[url("https://assets.prebuiltui.com/images/components/hero-section/hero-background-image.png")] bg-cover bg-center bg-no-repeat pb-10'>
                <nav className="flex flex-col items-center w-full" >
                    ...
                    <div className="flex items-center justify-between p-4 md:px-16 lg:px-24 xl:px-32 md:py-4 w-full">
                        <h1
                            className="text-3xl font-extrabold bg-clip-text text-transparent bg-center bg-cover"
                                style={{
                                 backgroundImage:
                                     "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQpR-7MQ79RX7f_dfTFPCc1SESSuC1yv6PMiA&s')",
                                        WebkitTextStroke: "0.5px white", // 🔴 red border each letter
                                }}
                        >
                         RESUME
                        </h1>
                        ...
                        <div id="menu" className={`${mobileOpen ? 'max-md:w-full' : 'max-md:w-0'} max-md:fixed max-md:top-0 max-md:z-10 max-md:left-0 max-md:transition-all max-md:duration-300 max-md:overflow-hidden max-md:h-screen max-md:bg-black/50 max-md:backdrop-blur max-md:flex-col max-md:justify-center flex items-center gap-8 text-sm`}>
                            <Link to="/services" onClick={() => setMobileOpen(false)} className="text-white/70 hover:text-white/80">Services</Link>                            
                            <Link to="/about" onClick={() => setMobileOpen(false)} className="text-white/70 hover:text-white/80">About</Link>
                            <a href="#features" onClick={() => setMobileOpen(false)} className="text-white/70 hover:text-white/80">Feature</a>

                            <a href="#Testimonials" onClick={() => setMobileOpen(false)} className="text-white/70 hover:text-white/80">Testimonials</a>
                            <a href="#Footer" onClick={() => setMobileOpen(false)} className="text-white/70 hover:text-white/80 mr-6">Contact</a>
                ...
                <h1 className="text-4xl md:text-[64px]/[82px] text-center max-w-4xl mt-5 bg-clip-text leading-tight px-4">
                    Land your dream interviews with Smart Resume Builder
                </h1>
                <p className="text-sm md:text-base text-gray-300 bg-clip-text text-center max-w-lg mt-4.5 px-4">
                   An intelligent resume builder designed to remove manual complexity and deliver polished results instantly.
                </p>

                <div className='flex gap-3 mt-8'>
                    <Link to="/app/service/Resume/Building">
                    <button className="bg-[#A6FF5D] hover:bg-[#A6FF5D]/90 text-gray-800 px-8 py-3.5 rounded-full text-sm transition cursor-pointer group">
                         <div className="relative overflow-hidden ">
                            <span className="block transition-transform duration-200 group-hover:-translate-y-full flex gap-2 ">
                                Start Building Resume  <ArrowBigRight size={16} strokeWidth={0.8} absoluteStrokeWidth className='mt-0.5'/>
                            </span>
                            <span className="absolute top-0 left-0 block transition-transform duration-200 group-hover:translate-y-0 translate-y-full flex gap-2">
                                Start Building Resume  <ArrowBigRight size={16} strokeWidth={0.8} absoluteStrokeWidth className='mt-0.5'/>
                            </span>
                        </div>
                    </button>
